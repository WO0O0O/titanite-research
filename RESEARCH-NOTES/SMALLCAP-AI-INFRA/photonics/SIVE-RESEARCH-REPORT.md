...
Sivers Semiconductors AB ($SIVE) represents a strong Tier 2 co-packaged optics (CPO) play, acting as the hard-coded reference design for GlobalFoundries' SCALE™ silicon photonics platform. This design-in status locks in downstream hyperscaler custom ASIC architectures, overriding its current low trailing market share. Sivers is a qualification-cycle player whose trailing revenue decline to SEK 61.9 million in Q1 2026 is secondary to its $799 million opportunity pipeline. However, Sivers' DSO of 271.3 days and 59.0% contract assets ratio represent a significant working capital drag, supporting Ningi Research's short allegations of collection risk. Geopolitical headwinds are introduced by its U.S. defence exposure and ITAR dual-use compliance requirements, given its reliance on Asian packaging for Glasgow-fabricated wafers. Trading at a $2.33 billion USD market capitalisation, Sivers' return maths indicates a 6.18x return to a $14.40 billion USD target valuation on LOI conversion, with the planned Nasdaq New York listing acting as the discovery catalyst.
