...
## Strategic Allocation Categories (SMALLCAP-AI-INFRA)

### 1. Buy / Scale-In Immediately (Top 10 Active Core)

- **LPK (LPKF Laser & Electronics) — 20%:** Structural glass core substrate chokepoint. Hold through short-term legacy solar fluctuations.
- **TRT (Trio-Tech International) — 15%:** Malaysia-Singapore burn-in testing chokepoint. Penang expansion and $7.8M orders are high-conviction catalysts.
- **AL2SI (2CRSi S.A.) — 15%:** Liquid-cooled server integration. Ramping Godì 1.8 Blackwell Ultra servers ahead of Sacramento delivery.
- **SHT (Smart High-Tech) — 10%:** Nvidia approved supplier (25 May 2026) and Henkel partnership. Trade via German ticker **7H6** to bypass Spotlight broker lock.
...
### 2. On the Sidelines / Watchlist

- **AAOI (Applied Optoelectronics):** Primary liquidity anchor. Parks the balance of Space trim proceeds and Swedish lock capital.
- **NBIS (Nebius Group):** Secondary liquidity anchor.
- **SEE (Seeing Machines) — Watchlist (SEYE proxy):** Active DMS alternative. Scale-in only if Magna refinancing clears before 30 June.
- **EOS (Electro Optic Systems) — Watchlist (11/13, Tier 1):** Defense drone chokepoint, but holds lower return upside (2.1x-3.4x).
- **NCI (Nippon Chemical Industrial) — Watchlist (10/13, Tier 2):** BaTiO3 MLCC powder with TDK JV, but valuation is already run-up.
- **IQE / PDC:** Under-performers / impaired. Post-DCA the positions are break-even. Avoid selling immediately on today's dip, but plan to fully liquidate on the next technical/stabilization bounce.
